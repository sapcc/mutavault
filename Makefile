...
build-all: build/mutavault

build/mutavault: FORCE
	@env $(GO_BUILDENV) go build $(GO_BUILDFLAGS) -ldflags '-s -w $(GO_LDFLAGS)' -o build/mutavault .
...
install: FORCE build/mutavault
	install -d -m 0755 "$(DESTDIR)$(PREFIX)/bin"
	install -m 0755 build/mutavault "$(DESTDIR)$(PREFIX)/bin/mutavault"
...
help: FORCE
	...
	@printf "  \e[36mbuild/mutavault\e[0m            Build mutavault.\n"
